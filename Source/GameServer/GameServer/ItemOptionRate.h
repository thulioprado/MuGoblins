...
private:
	std::unordered_map<int,ITEM_OPTION0_RATE_INFO> m_ItemOption0RateInfo;
	std::unordered_map<int,ITEM_OPTION1_RATE_INFO> m_ItemOption1RateInfo;
	std::unordered_map<int,ITEM_OPTION2_RATE_INFO> m_ItemOption2RateInfo;
	std::unordered_map<int,ITEM_OPTION3_RATE_INFO> m_ItemOption3RateInfo;
	std::unordered_map<int,ITEM_OPTION4_RATE_INFO> m_ItemOption4RateInfo;
	std::unordered_map<int,ITEM_OPTION5_RATE_INFO> m_ItemOption5RateInfo;
};
