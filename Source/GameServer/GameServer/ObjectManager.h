...
public:
	...
	bool CharacterLevelUp(LPOBJ lpObj, QWORD& AddExperience, int MaxLevelUp, int ExperienceType);
	...
	bool CharacterUseEnergy(LPOBJ lpObj, int SourceSlot, int TargetSlot);
