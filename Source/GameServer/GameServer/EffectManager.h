...
public:
	...
	void InsertViewSkillState(LPOBJ lpObj, BYTE index);
	void RemoveViewSkillState(LPOBJ lpObj, BYTE index);
	void GCEffectStateSend(LPOBJ lpObj, BYTE state, DWORD ViewSkillSTate);
