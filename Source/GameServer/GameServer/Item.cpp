...
void CItem::Convert(int index, BYTE Option1, BYTE Option2, BYTE Option3, BYTE NewOption, BYTE SetOption) // OK
{
	...
	if (ItemInfo.RequireLevel != 0)
	{
		...
		else if (this->m_Index >= GET_ITEM(12, 7) && this->m_Index <= GET_ITEM(12, 24) && this->m_Index != GET_ITEM(12, 15)) // Orbs, Scrolls
		{
			this->m_RequireLevel = ItemInfo.RequireLevel;
		}
	...
	if (this->m_Index == GET_ITEM(13, 30)) // Cloak of Lord
	{
		this->m_Defense = 15;
	}
	...
	if (this->m_Defense > 0)
	{
		...
		else
		{
			...
			if ((this->m_Index >= GET_ITEM(12, 3) && this->m_Index <= GET_ITEM(12, 6)) || this->m_Index == GET_ITEM(13, 4)) // 2sd Wings,Dark Horse
			{
...
void CItem::Value() // OK
{
	...
	else
	{
		...
		if (((this->m_Index / MAX_ITEM_TYPE) == 12 && (this->m_Index > GET_ITEM(12, 6) && this->m_Index < GET_ITEM(12, 32))) || (this->m_Index / MAX_ITEM_TYPE) == 13 || (this->m_Index / MAX_ITEM_TYPE) == 15)
		{
