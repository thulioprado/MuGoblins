...
void CJewelMix::CGJewelMixRecv(PMSG_JEWEL_MIX_RECV* lpMsg,int aIndex) // OK
{
	...
	GDCreateItemSend(aIndex,0xEB,0,0,this->GetJewelBundleIndex(lpMsg->type),lpMsg->level,0,0,0,0,-1,0,0,0);
...
void CJewelMix::CGJewelUnMixRecv(PMSG_JEWEL_UNMIX_RECV* lpMsg,int aIndex) // OK
{
	...
	{
		GDCreateItemSend(aIndex,0xEB,0,0,this->GetJewelSimpleIndex(lpMsg->type),0,0,0,0,0,-1,0,0,0);
	}
