		...
		while(true)
		{
			...
			while(true)
			{
				if(section == 0)
				{
					...
					this->m_ItemOption0RateInfo[info.Index] = info;
				}
				else if(section == 1)
				{
					if(strcmp("end",lpMemScript->GetAsString()) == 0)
					...
					this->m_ItemOption1RateInfo[info.Index] = info;
				}
				else if(section == 2)
				{
					if(strcmp("end",lpMemScript->GetAsString()) == 0)
					...
					this->m_ItemOption2RateInfo[info.Index] = info;
				}
				else if(section == 3)
				{
					if(strcmp("end",lpMemScript->GetAsString()) == 0)
					...
					this->m_ItemOption3RateInfo[info.Index] = info;
				}
				else if(section == 4)
				{
					if(strcmp("end",lpMemScript->GetAsString()) == 0)
					...
					this->m_ItemOption4RateInfo[info.Index] = info;
				}
				else if(section == 5)
				{
					if(strcmp("end",lpMemScript->GetAsString()) == 0)
					...
					this->m_ItemOption5RateInfo[info.Index] = info;
				}
				else
				{
					break;
...
{
	auto it = this->m_ItemOption0RateInfo.find(index);
...
{
	auto it = this->m_ItemOption1RateInfo.find(index);
...
{
	auto it = this->m_ItemOption2RateInfo.find(index);
...
{
	auto it = this->m_ItemOption3RateInfo.find(index);
...
{
	auto it = this->m_ItemOption4RateInfo.find(index);
...
{
	auto it = this->m_ItemOption5RateInfo.find(index);
