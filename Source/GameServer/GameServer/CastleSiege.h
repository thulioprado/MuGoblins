...
public:
	...
	std::unordered_map<std::string,_CS_TOTAL_GUILD_DATA> m_mapCsBasicGuildInfo; // 154
	CRITICAL_SECTION m_critCsBasicGuildInfo; // 164
	std::unordered_map<std::string,_CS_TOTAL_GUILD_DATA> m_mapCsTotalGuildInfo; // 17C
	CRITICAL_SECTION m_critCsTotalGuildInfo; // 18C
	int m_bCsBasicGuildInfoLoadOK; // 1A4
	int m_bCsTotalGuildInfoLoadOK; // 1A8
	std::unordered_map<int,_CS_MINIMAP_DATA> m_mapMiniMapData; // 1AC
