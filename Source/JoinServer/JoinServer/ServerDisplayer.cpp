...
void CServerDisplayer::SetWindowName() // OK
{
	...
	wsprintf(buff,"[%s] MuEMU JoinServer (QueueSize : %d) (AccountCount : %d/%d)",JOINSERVER_VERSION,gSocketManager.GetQueueSize(),gAccountManager.GetAccountCount(), MAX_ACCOUNT);
