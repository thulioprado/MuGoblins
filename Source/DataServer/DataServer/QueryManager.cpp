...
bool CQueryManager::Query(char* query) // OK
{
	SQLRETURN result;

	if (SQL_SUCCEEDED((result = SQLExecDirect(this->m_STMT, (SQLCHAR*)query, SQL_NTS))) == 0 && result != SQL_NO_DATA)
	{
